...
targets = [286201.63, 250066.93, 208208.93, 171105.18]
found = []
for t in transactions:
    b = t.get("balance")
    if b in targets:
        found.append(b)
        print(f"FOUND: Bal: {b} | Date: {t.get('date')} | Deb: {t.get('debit')} | Cred: {t.get('credit')}")

print(f"Missing: {set(targets) - set(found)}")
